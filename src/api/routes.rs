...
use crate::indexer::{Indexer, IndexStats, SearchResult};
...
mod tests {
    ...
    fn create_test_indexer() -> Indexer {
        ...
        indexer.index_document(1, crate::parser::ParsedDocument::new(
            "test1.html".to_string(),
            "Test Title 1".to_string(),
            "Test content one".to_string(),
        ));
        indexer.index_document(2, crate::parser::ParsedDocument::new(
